...
class _SearchWidgetState extends State<SearchWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      context.pushNamed('Details13PropertyHallCopy3');
    });
                            ...
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    context.pushNamed('Details13PropertyHall');
                                  },
                                  child: ClipRRect(
                            ...
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    context
                                        .pushNamed('Details13PropertyHallCopy');
                                  },
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(10.0),
                                    child: Image.asset(
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      'Hall Name: Elite Elegance Manor',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyLarge
                                          .override(
                                            fontFamily: 'Readex Pro',
