...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFF1EBE7);
  late Color secondary = const Color(0xFFE4E0DD);
  late Color tertiary = const Color(0xFFE7E3E0);
  late Color alternate = const Color(0xFFEAE6E3);
  ...
  late Color accent1 = const Color(0xFFFF6381);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFD1CBC7);
  late Color secondary = const Color(0xFFC4C0BD);
  late Color tertiary = const Color(0xFFC7C3C0);
  late Color alternate = const Color(0xFFCAC6C3);
  ...
  late Color accent1 = const Color(0xFFD13E6B);
